import { Button, ErrorAlert, TextInput } from "@/components/ui";
import { AUTH_ROUTES, AUTH_VALIDATION } from "@/constants/auth";
...
/**
 * Verify2FAScreen - Two-factor authentication verification
 *
 * This screen handles 2FA verification when user has it enabled.
 * Clerk sends a code to the user's email that must be verified here.
 */
