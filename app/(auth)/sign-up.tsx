import { Button, ErrorAlert, FormInput, OrDivider } from "@/components/ui";
import { AUTH_MESSAGES, AUTH_ROUTES } from "@/constants/auth";
import { theme } from "@/constants/theme.design";
import { SignUpFormData, useSignUpLogic } from "@/hooks/use-sign-up-logic";
 ...
 *
 * Architecture:
 * - Business logic extracted to useSignUpLogic hook (MVVM pattern)
